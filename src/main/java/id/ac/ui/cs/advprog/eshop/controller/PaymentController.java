...
public class PaymentController {
    ...
    public String adminListPaymentsPage(Model model) {
    ...
    public String adminDetailPaymentPage(@PathVariable String paymentId, Model model) {
        Payment payment = paymentService.getPayment(paymentId);
        model.addAttribute("payment", payment);
    ...
    public String adminSetPaymentStatusPost(@PathVariable String paymentId, @RequestParam String status) {
        Payment payment = paymentService.getPayment(paymentId);
        if (payment != null) {
